...
import { RELATIONSHIP_STATUS_LABELS } from '@/types/relationship.ts'
import { t } from '@/i18n/index.ts'

const ENTITY_TYPES = Object.keys(ENTITY_TYPE_LABELS) as EntityType[]

const STATUS_ITEMS = [
  { label: RELATIONSHIP_STATUS_LABELS.confirmed, style: 'border-b-2 border-slate-500' },
  { label: RELATIONSHIP_STATUS_LABELS.probable, style: 'border-b-2 border-slate-400 opacity-80' },
  { label: RELATIONSHIP_STATUS_LABELS.inferred, style: 'border-b-2 border-dashed border-slate-300' },
  { label: RELATIONSHIP_STATUS_LABELS.disputed, style: 'border-b-2 border-dotted border-slate-200' },
]
